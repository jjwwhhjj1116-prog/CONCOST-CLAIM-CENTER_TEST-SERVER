...
const migration = requestedMigration ?? '0059_cf114_report_workspace_version_guard.sql';
assert.ok(['0059_cf114_report_workspace_version_guard.sql','0060_cf116_workflow_import_access_guard.sql'].includes(migration), 'explicit reviewed trigger migration');
