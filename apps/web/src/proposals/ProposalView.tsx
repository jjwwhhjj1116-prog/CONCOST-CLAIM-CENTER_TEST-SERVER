    ...
    {activeProposal&&<Card title={`${activeProposal.title} · 4단계 제안서 스튜디오`} className="proposal-step-card">
      ...
      {step===3&&<div className="proposal-stage proposal-editor-stage">
        ...
        <div className="proposal-editor-grid">
          ...
          <DocumentPreviewPane title="4단계와 동일한 현재 장 페이지">
            {reviewSurface==='chapter'?<ProposalFinalChapterPages item={chapter} startPage={3} onPageCount={ignoreProposalPageCount}/>:reviewSurface==='cover'?<ProposalCoverPage projectTitle={projectTitle} subtitle={subtitle} clientName={clientName} submissionDate={submissionDate}/>:<ProposalTableOfContentsPage chapters={chapters} pageCounts={{}}/>}
          </DocumentPreviewPane>
        </div>
        {canManageModules&&<>
